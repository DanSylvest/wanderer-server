...
const request = async function (_connectionId, _responseId, _event) {
  ...
  try {
    ...
    const hasAdded = await map.addManual(_event.solarSystemId, _event.x, _event.y);
    ...
    await saveMapUserActions(userId, _event.mapId, 'addSolarSystem', { solarSystemId: _event.solarSystemId });
