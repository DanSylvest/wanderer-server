...
const subscriber = async function (_connectionId, _responseId, event) {
    ...
    try {
        ...
        core.mapController.get(mapId).subscribers.subscribeOnlineCharacters(_connectionId, _responseId, userId);
    } catch (err) {
...
subscriber.unsubscribe = async function (_connectionId, _responseId, event) {
    ...
    try {
        ...
        await core.mapController.get(event.mapId).subscribers.unsubscribeOnlineCharacters(_connectionId, _responseId, userId);
    } catch (err) {
